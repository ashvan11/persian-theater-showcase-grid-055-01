...
const BookTicket = () => {
  ...
  const showtimes: Showtime[] = [
    ...
    },
    {
      ...
      status: "موجود",
      remaining: 32,
      countdown: "خرید در 2 ساعت و 33 دقیقه",
    },
    {
      id: "3",
      day: "دوشنبه",
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <nav className="mb-6">
          <ol className="flex items-center gap-2 text-sm text-foreground/60">
            ...
            <li>/</li>
            <li>
              <Link to={`/show/${id}`} className="hover:text-gold-500">
                جزئیات نمایش
              </Link>
            </li>
            <li>/</li>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-card rounded-lg p-6">
              <div className="flex items-center gap-2 mb-4">
                <div className="w-6 h-6 rounded-full bg-gold-500 text-background flex items-center justify-center text-sm font-bold">
                  1
                </div>
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        <div className="font-semibold">
                          {showtime.day} {showtime.date} - {showtime.time}
                        </div>
                        <div className="text-sm text-foreground/60">
                          {showtime.status === "تکمیل"
                            ? "تکمیل ظرفیت"
                            : `${showtime.remaining} صندلی باقی‌مانده`}
                        </div>
                        {showtime.countdown && (
            ...
            {selectedShowtime && (
              <div className="bg-card rounded-lg p-6">
                ...
                <div className="mb-4 text-sm text-foreground/60">
                  سانس انتخاب شده:{" "}
                  {showtimes.find((s) => s.id === selectedShowtime)?.day}{" "}
                  {showtimes.find((s) => s.id === selectedShowtime)?.date} -{" "}
              ...
              <div className="bg-card rounded-lg p-6">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <p className="text-blue-800 mb-2">
                    ...
                    <button className="text-blue-600 underline mx-1">
                      اینجا کلیک کنید تا وارد شوید یا ثبت نام کنید
                    </button>
                  </p>
                  <p className="text-blue-700 text-sm">
                    مزایای عضویت: عدم نیاز به وارد کردن مجدد اطلاعات، دسترسی به
                    تاریخچه خرید، تخفیف‌های ویژه و تخفیف وفاداری.
                  </p>
                </div>
              </div>
            )}
